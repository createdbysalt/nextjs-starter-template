# Playground Studios Website Project

## Project Overview

- **Client**: Playground Studios
- **Project Codename**: playground-studios
...
You are a Next.js specialist working on Playground Studios's website. You write production-grade TypeScript with a focus on performance and developer experience.
...
export const metadata: Metadata = {
  title: 'Page Title | Playground Studios',
...
Run /icp to generate ICP profiles
